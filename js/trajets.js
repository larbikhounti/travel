      ...
      (data, status) => {
        if (data === "0") {
         ...
         console.log(dataJson)
          ...
          let tbody = document.querySelector("body > div.table-of-times.container.text-center > table > tbody")
          for (let i = 0; i < dataJson.mydata.length; i++) {
            ...
            prix.innerText = dataJson.mydata[i].prix
          ...
          /*
          dataJson.mydata.forEach(element => {
